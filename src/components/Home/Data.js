  ...
  return (
    <>
      <div className="home__data">
        <h1 className="home__title" style={{fontSize: "2.6rem", fontWeight: "2.4rem"}}>Syed Zain Aly
        ...
        <h3 className="home__subtitle">Advocate, Terrorist Lawyer<br />Enginer, Software Developer </h3>
        <p className="home__description">I'm creative designer based in Khurasan from Masrik, and I'm very passionate and dedicated to my work</p>
